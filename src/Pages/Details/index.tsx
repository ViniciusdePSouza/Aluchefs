import { Container, IconButton, InfoDiv, IngredientItem, IngredientsList, IngredientsSection, PreviewSection, SectionTitle } from "./styles";
...
export function Details() {
    ...
    function transformToArray(inputString: string) {
        ...
        const resultArray = lines.map((line) => (line.startsWith('-') ? line : `- ${line}`));
